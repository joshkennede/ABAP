...
TYPES: BEGIN OF t_output,
        werks   LIKE zht_grpnum_bplan-werks,
        bplan   LIKE zht_grpnum_bplan-bplan,
        grpnum  LIKE zht_grpnum_bplan-grpnum,
       END OF t_output.
...
SELECTION-SCREEN COMMENT 01(15) text-002.
...
FORM f_setup_alv_header CHANGING t_heading TYPE slis_t_listheader.
  ...
  rpt_title = 'ZHT_GRPNUM_BPLAN Table'.
